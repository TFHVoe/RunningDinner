...
def wensen(df, gt, df_kookte_2022, df_adressen, df_tafelgenoot_2022, df_buren, df_tafelgenoot_2021):#Een Functie die alle wensen controleert.
    ...
    return  count_meer_dan_twee_keer_zelfde_persoon, count_hoofdgerecht2022, count_voorkeur, count_zelfde_tafelpartner_2022,count_met_buren_aan_tafel,count_zelfde_tafelpartner_2021,

print(wensen(df, gt, df_kookte_2022, df_adressen, df_tafelgenoot_2022, df_buren, df_tafelgenoot_2021))